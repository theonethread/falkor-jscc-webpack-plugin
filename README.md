...
Release sources can be found on the `master` branch, this one always points to the latest tagged release. Previous sources of releases can be found using `git` version tags (or browsing GitHub releases). Released packages can be found on [npmjs](https://www.npmjs.com/package/@falkor/falkor-jscc-webpack-plugin "Visit").
...
The latest sources can always be found on [GitHub](https://github.com/theonethread/falkor-jscc-webpack-plugin "Visit").
...
[MIT](https://github.com/theonethread/falkor-jscc-webpack-plugin/blob/master/license.txt "Open")
